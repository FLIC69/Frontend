...
import { ChevronRight, Droplets, Sprout, Thermometer, Bot } from 'lucide-react'
...
const Parameters: React.FC = () => {
  ...
  return (
    <motion.div
      className="py-8 flex flex-col items-center min-h-[calc(100vh-60px)]"
          ...
          >
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <Sprout className="mr-2 text-primary-500" size={20} />
                Soil Nutrients
              </h2>

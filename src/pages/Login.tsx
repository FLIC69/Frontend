...
const Login: React.FC = () => {
  ...
  return (
    <motion.div
      className="min-h-[calc(100vh-130px)] flex flex-col justify-center py-12 sm:px-6 lg:px-8"
    ...
    >
      ...
      >
        ...
        <motion.h2 variants={itemFade} className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          Welcome to Crop Recommendation System
        </motion.h2>
        <motion.p variants={itemFade} className="mt-2 text-center text-sm text-gray-600">
